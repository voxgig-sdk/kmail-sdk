...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_email"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KmailSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kmail_list",
		Description: "List records from Kmail. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kmail_load",
		Description: "Load a single record from Kmail. " +
...
func runOp(client *sdk.KmailSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KmailSDK, name string) (sdk.KmailEntity, error) {
	switch strings.ToLower(name) {
	case "get_email":
		return client.GetEmail(nil), nil
