# Kmail SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KmailSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KmailSDK(...) and KmailSDK.test(...) become
#      KmailSDK.test({"entity": {...}}) seeding one mock record (id "test01")
