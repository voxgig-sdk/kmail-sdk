...
from kmail_sdk.utility import register
...
class KmailSDK:
    ...
    def get_utility(self):
        return KmailUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KmailSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetEmail(self, data=None) -> "GetEmailEntity":
        ...
        from kmail_sdk.entity.get_email_entity import GetEmailEntity
