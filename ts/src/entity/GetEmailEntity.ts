...
class GetEmailEntity extends KmailEntityBase<GetEmail> {
  ...
  constructor(client: KmailSDK, entopts: any) {
    ...
    this.name = 'get_email'
    this.name_ = 'get_email'
    this.Name = 'GetEmail'
  }


  make(this: GetEmailEntity) {
    return new GetEmailEntity(this._client, this.entopts())
  }
  ...
  async list(this: any, reqmatch?: GetEmailListMatch, ctrl?: Control): Promise<GetEmail[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<GetEmail[]> return stays clean under strict null checks.
