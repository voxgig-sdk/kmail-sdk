...
describe('GetEmailDirect', async () => {
  ...
  test('direct-list-get_email', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-get_email', setup.live)) return
