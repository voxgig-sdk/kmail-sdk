...
KmailSDK._make_feature = _make_feature


function KmailSDK.new(options)
  local self = setmetatable({}, KmailSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KmailSDK:get_utility()
  return Utility.copy(self._utility)
end


function KmailSDK:get_root_ctx()
  return self._rootctx
end


function KmailSDK:prepare(fetchargs)
...
function KmailSDK:direct(fetchargs)
...
-- by passing it.
function KmailSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KmailSDK:graphql(query, variables, ctrl)
...
function KmailSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KmailSDK.new(sdkopts)
  sdk.mode = "test"
