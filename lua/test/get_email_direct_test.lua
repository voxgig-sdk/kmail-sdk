...
describe("GetEmailDirect", function()
  it("should direct-list-get_email", function()
    local setup = get_email_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_email", setup.live and "live" or "unit")
