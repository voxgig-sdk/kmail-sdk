...
module KmailTestRunner
  ...
  def self.env_override(m)
    live = getenv("KMAIL_TEST_LIVE")
    override = getenv("KMAIL_TEST_OVERRIDE")
    ...
    explain = getenv("KMAIL_TEST_EXPLAIN")
    m["KMAIL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = KmailTestRunner
Helpers = KmailHelpers
Vs = VoxgigStruct
