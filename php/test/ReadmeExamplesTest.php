...
// Kmail SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KmailSDK::test)
...
{
    private const SDK_CLASS = 'KmailSDK';
    ...
    private const SDK_BASE = 'kmail_sdk';
