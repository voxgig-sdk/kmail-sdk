...
class GetEmailEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = KmailSDK::test($seed, null);
        $seen = iterator_to_array($base->GetEmail(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->GetEmail(null)->stream("list", null, null) as $item) {
