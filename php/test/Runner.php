...
class KmailTestRunner
{
    ...
    {
        $live = self::getenv('KMAIL_TEST_LIVE');
        $override = self::getenv('KMAIL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('KMAIL_TEST_EXPLAIN');
...
class_alias('KmailTestRunner', 'Runner');
class_alias('KmailHelpers', 'Helpers');
