...
class KmailStreamingFeature extends KmailBaseFeature
{
    ...
    private function _iterate(KmailResult $result): \Generator
    {
    ...
    private function _streamable(KmailContext $ctx): bool
    {
