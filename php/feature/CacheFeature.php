...
class KmailCacheFeature extends KmailBaseFeature
{
    ...
    private function _through(KmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
