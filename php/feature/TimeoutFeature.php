...
class KmailTimeoutFeature extends KmailBaseFeature
{
    ...
    private function _with_timeout(KmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KmailContext $_ctx, float $ms): void
    {
        $client = $this->client;
