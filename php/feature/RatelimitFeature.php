...
class KmailRatelimitFeature extends KmailBaseFeature
{
    ...
    private function _acquire(KmailContext $ctx): void
    {
    ...
    private function _track(KmailContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
