...
class KmailClienttrackFeature extends KmailBaseFeature
{
    ...
    public function PostConstruct(KmailContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Kmail-SDK';
