...
// Kmail SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KmailMakeRequest
{
    public static function call(KmailContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KmailResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KmailResponse($fetched);
        } else {
