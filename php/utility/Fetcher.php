...
class KmailFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KmailSDK/1.0)';
    ...
    public static function call(KmailContext $ctx, string $fullurl, array $fetchdef): array
    {
