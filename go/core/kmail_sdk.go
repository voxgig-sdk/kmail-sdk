...
func (sdk *KmailSDK) OptionsMap() map[string]any {
...
func (sdk *KmailSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *KmailSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *KmailSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KmailSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *KmailSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *KmailSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("KmailSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *KmailSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KmailSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("KmailSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
