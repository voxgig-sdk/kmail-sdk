...
type GetEmailEntity struct {
	name    string
	client  *core.KmailSDK
...
func NewGetEmailEntity(client *core.KmailSDK, entopts map[string]any) *GetEmailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetEmailEntity) GetName() string { return e.name }
...
func (e *GetEmailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetEmailEntity) Deleted() bool {
	return e.deleted
}


func (e *GetEmailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetEmailEntity(e.client, opts)
}

func (e *GetEmailEntity) Data(args ...any) any {
...
func (e *GetEmailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetEmailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetEmailEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GetEmailEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetEmailEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetEmailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetEmailEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
