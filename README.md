...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/kmail` | `npm install @voxgig-sdk/kmail` |
| Python | `voxgig-sdk-kmail` | `pip install voxgig-sdk-kmail` |
| PHP | `voxgig-sdk/kmail` | `composer require voxgig-sdk/kmail` |
| Golang | `github.com/voxgig-sdk/kmail-sdk/go` | `go get github.com/voxgig-sdk/kmail-sdk/go` |
| Ruby | `voxgig-sdk-kmail` | `gem install voxgig-sdk-kmail` |
| Lua | `voxgig-sdk-kmail` | `luarocks install voxgig-sdk-kmail` |
