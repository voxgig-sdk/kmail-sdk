...
class KmailRbacFeature extends KmailBaseFeature
{
    ...
    private function _required(KmailContext $ctx): ?string
    {
    ...
    private function _reject(KmailContext $ctx, string $required): void
    {
    ...
    private function _track(KmailContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
