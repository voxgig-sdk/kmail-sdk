...
class KmailProxyFeature extends KmailBaseFeature
{
    ...
    public function init(KmailContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KmailContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
