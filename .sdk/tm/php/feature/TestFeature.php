...
// Kmail SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KmailTestFeature extends KmailBaseFeature
{
    ...
    public function init(KmailContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KmailContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KmailContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KmailContext $ctx, $op, $args): array
    {
