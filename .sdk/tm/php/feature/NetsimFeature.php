...
class KmailNetsimFeature extends KmailBaseFeature
{
    ...
    private function _simulate(KmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KmailContext $ctx, array $applied): void
    {
        $client = $this->client;
