...
class KmailContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, KmailResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KmailError(code, msg, self)
