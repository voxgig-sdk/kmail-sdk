...
class KmailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KmailTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = KmailTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = KmailTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
